...
>**Persistência**: foi feita em arquivo *.txt*, o qual funciona como o banco de dados do sistema, é resgatado dados de dentro do arquivo de texto e é escrito dados dentro do mesmo.
